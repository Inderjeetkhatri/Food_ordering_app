...
import com.example.foodrunner.Activities.RestaurantMenuActivity.Companion.resId
import com.example.foodrunner.Adapter.RestrauntMenuAdapter
import com.example.foodrunner.Adapter.cartrecylerAdapter
import com.example.foodrunner.R
import com.example.foodrunner.Util.ConnectionManager
import com.example.foodrunner.database.cartDatabase
import com.example.foodrunner.database.CartEntities
...
// here we are converting the string back to list in order to display
    ...
    // finvtion for placing the order
        ...
        if (ConnectionManager().isNetworkAvailable(this@CartActivity)) {
            ...
            jsonParams.put(
                ...
                this@CartActivity.getSharedPreferences(
                    "FoodRunner",
                    Context.MODE_PRIVATE              // we bring the the user id back from the shareedPreferences
                ).getString(
                    "user_id",
                    null
                ) as String
    ...
    //class for clearing the recently added items from the database
